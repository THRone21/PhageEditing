for i in $(ls /ldfssz1/ST_INFECTION/P17Z10200N0246_Phage_XMF/USER/liuwei/cryosphere/Permafrost3/202107_06_bc48_pooling/04.4_blastn_Virus-host-dephage-db/04.4.1_blastn_spades/scaffolds.allvirus.fasta)
	do
		A=`echo $(basename $i .fa)`
		##目的路径 防止任务跑断 故判断续跑检查用
		address="/ldfssz1/ST_INFECTION/P17Z10200N0246_Phage_XMF/USER/liuwei/cryosphere/Permafrost3/202107_06_bc48_pooling//04.4_blastn_Virus-host-dephage-db/04.4.1_blastn_spades/06.1_annotation$A"
		if [ -d $address ];
		then
